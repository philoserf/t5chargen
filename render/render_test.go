...
// TestScoutSheetGolden and TestScoutHistoryGolden pin the Scout sheet and
// transcript: the career whose record exercises the status line (Fame,
// Wound Badges), Discoveries, and the injury consequences.
