...
//
// Valid once Err has reported nil. A Birth Date Generation table that failed to load comes back
...
// Err reports whether the embedded Birth Date Generation table failed to load. It is compiled
