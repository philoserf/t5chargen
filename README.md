...
is in progress with 3 of 13 careers playable.
...
- The **Citizen**, **Scout**, and **Merchant** careers end-to-end:
  controlling characteristics, per-term skills, Risk & Reward, injury and
  death, rank with commission and promotion, continuation checks.
...
Not yet implemented: the other 10 careers, aging, career changes, muster out
...
`--name`, `--career citizen|scout|merchant`, `--homeworld "UWP TC TC..."` (for example
