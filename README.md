...
is in progress with 9 of 13 careers playable.
...
- The **Citizen**, **Scholar**, **Entertainer**, **Scout**, **Merchant**,
  **Noble**, and the Armed Forces (**Spacer**, **Soldier**, **Marine**)
  careers end-to-end: controlling characteristics, per-term
...
Not yet implemented: the other 4 careers, aging, career changes, muster out
...
`--name`, `--career citizen|scholar|entertainer|scout|merchant|spacer|soldier|noble|marine`, `--homeworld "UWP TC TC..."` (for example
