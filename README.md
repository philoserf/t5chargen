...
is in progress with 6 of 13 careers playable.
...
- The **Citizen**, **Scholar**, **Entertainer**, **Scout**, and
  **Merchant**, and **Noble** careers end-to-end: controlling characteristics, per-term
  ...
  publications and waivers, continuation checks.
...
Not yet implemented: the other 7 careers, aging, career changes, muster out
...
`--name`, `--career citizen|scholar|entertainer|scout|merchant|noble`, `--homeworld "UWP TC TC..."` (for example
