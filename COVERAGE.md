...
| "Once Aging begins, it occurs every four years on the character's birthday" | p. 89 chart A                 | `Character.ageEffects`                                              | `TestAgingCheckSchedule`                                         | interpretation I-50 (absolute ages; no birthdate — FR8's only cite is the Archive)                                                                                                                                                                                      |
